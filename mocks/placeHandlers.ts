...
const MOCK_PLACE_DETAILS: Record<number, PlaceDetailResponse> = {
  ...
  101: {
    ...
    businessHours: "10:00–18:00",
    description:
      "아시아 문화 교류의 중심, 전시와 공연이 열리는 복합문화공간이다.",
    thumbnailUrl: null,
  },
  102: {
    placeId: 102,
    ...
    longitude: 126.9142,
    businessHours: "24시간 개방",
    description: "근대 건축과 골목이 남아 광주의 시간을 걷는 산책길이다.",
    thumbnailUrl: null,
  },
  103: {
    placeId: 103,
    ...
    description: "광주를 대표하는 오래된 빵집으로 지역 미식의 상징이다.",
    thumbnailUrl: null,
  },
  104: {
    placeId: 104,
    ...
    longitude: 126.9088,
    businessHours: "24시간 개방",
    description: "도심을 한눈에 담는 전망 공간으로 산책과 함께 쉬어가기 좋다.",
    thumbnailUrl: null,
  },
  105: {
    placeId: 105,
    ...
    longitude: 126.9,
    businessHours: "24시간 개방",
    description: "5·18 민주화운동의 정신을 기리기 위해 조성된 공원이다.",
    thumbnailUrl: null,
  },
};
...
const EXTRA_MOCK_PLACE_SEEDS = [
  ...
  ["월봉서원", "역사", "REMEMBERER", 35.213, 126.7442, ["선비문화", "고택"]],
